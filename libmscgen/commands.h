...
{
public:
    ArcCommand(MscProgress::ECategory c, Msc *msc) : ArcBase(c, msc) {};
    bool AddAttribute(const Attribute &) override { return false; }
    void Layout(Canvas &canvas, AreaList *cover) override;
    void Draw(Canvas &/*canvas*/, EDrawPassType /*pass*/) override = 0;
};
...
public:
    ...
    void AttachComment(CommandNote *) override;
    ...
    void PostPosProcess(Canvas &cover) override;
...
public:
    ...
    ~CommandNewpage() override { if (autoHeading) delete autoHeading; }
...
public:
    CommandEmpty(Msc *msc) : 
        ArcCommand(MscProgress::EMPTY, msc) {}
    void Width(Canvas &canvas, EntityDistanceMap &distances, DistanceMapVertical &vdist) override;
    void Layout(Canvas &canvas, AreaList *cover) override;
    void Draw(Canvas &canvas, EDrawPassType pass) override;
};
...
public:
    ...
    void SetStyleBeforeAttributes() override {} //styles are set in constructor
    bool AddAttribute(const Attribute &) override;
    static void AttributeNames(Csh &csh);
    static bool AttributeValues(const std::string attr, Csh &csh);
    ArcBase* PostParseProcess(Canvas &canvas, bool hide, EIterator &left, EIterator &right,
...
public:
    ...
    void SetStyleBeforeAttributes() override {} //no refinement: style set in constructor
    bool AddAttribute(const Attribute &) override;
...
public: 
    explicit CommandEndNoteSeparator(Msc *m) :
        ArcCommand(MscProgress::TINY_EFFORT, m) {}
    void Layout(Canvas &canvas, AreaList *cover) override;
    void PostPosProcess(Canvas &cover) override;
    void Draw(Canvas &canvas, EDrawPassType pass) override;
};
