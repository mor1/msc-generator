...
public:
	...
	virtual MscProgress::ECategory GetProgressCategory() const {return MscProgress::ENTITY;}
...
public:
	...
	virtual MscProgress::ECategory GetProgressCategory() const {return MscProgress::BACKGROUND;}
...
public:
	...
	virtual MscProgress::ECategory GetProgressCategory() const {return MscProgress::NUMBERING;}
    virtual ArcBase* PostParseProcess(Canvas &canvas, bool hide, EIterator &left, EIterator &right,
                                      Numbering &number, bool top_level, Element **note_target);
};
...
public:
	...
	virtual MscProgress::ECategory GetProgressCategory() const {return MscProgress::MARKER;}
    bool AddAttribute(const Attribute &);
    static void AttributeNames(Csh &csh);
    static bool AttributeValues(const std::string attr, Csh &csh);
...
public:
	...
	virtual MscProgress::ECategory GetProgressCategory() const {return MscProgress::EMPTY;}
    virtual void Width(Canvas &canvas, EntityDistanceMap &distances);
    virtual void Layout(Canvas &canvas, AreaList &cover);
...
public:
	...
	virtual MscProgress::ECategory GetProgressCategory() const {return MscProgress::HSPACE;}
...
public:
    CommandVSpace(Msc*);
	virtual MscProgress::ECategory GetProgressCategory() const {return MscProgress::VSPACE;}
    virtual bool AddAttribute(const Attribute &);
    static void AttributeNames(Csh &csh);
    static bool AttributeValues(const std::string attr, Csh &csh);
    virtual ArcBase* PostParseProcess(Canvas &canvas, bool hide, EIterator &left, EIterator &right,
...
public:
	...
	virtual MscProgress::ECategory GetProgressCategory() const {return MscProgress::SYMBOL;}
...
public:
    ...
    ~CommandNote();
	virtual MscProgress::ECategory GetProgressCategory() const {return is_float ? MscProgress::NOTE : MscProgress::COMMENT;} 
...
public:
	...
	virtual MscProgress::ECategory GetProgressCategory() const {return MscProgress::LIST;} 
