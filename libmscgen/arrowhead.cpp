...
Contour ArrowHead::BigMidLine(std::vector<double> xPos, std::vector<double> act_size, double sy, double dy, bool bidir) const
{
    Contour area;
...
{
    const Contour area = BigMidLine(xPos, act_size, sy, dy, bidir);
