...
enum class EArcSymbol
{
    ...
    ARC_DOUBLE2,             ///<This is a ==> or <==, but also used for mscgen unidir arrow with colon: :> or <: (ArcDirArrow, ArcSelfArrow, ArcBigArrow, ArcVertical)
    ARC_DOUBLE2_BIDIR,       ///<This is a <==>, but also used for mscgen bidirectional arrow with colon: <:> (ArcDirArrow, ArcSelfArrow, ArcBigArrow, ArcVertical)
