...
//Drawing related
    ...
    size_t DrawToMetafile(HDC hdc, MscCanvas::OutputType type, bool pageBreaks, bool force_page=false, unsigned forced_page=0, Contour *fallback_images=NULL) const; 
    HENHMETAFILE DrawToEMF(MscCanvas::OutputType type, bool pageBreaks, bool force_page, unsigned forced_page, size_t *size, Contour *fallback_images) const;
